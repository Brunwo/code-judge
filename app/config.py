...
JAVA_COMPILER_PATH = env('JAVA_COMPILER_PATH', 'javac')
JAVA_RUNTIME_PATH = env('JAVA_RUNTIME_PATH', 'java')
KOTLIN_COMPILER_PATH = env('KOTLIN_COMPILER_PATH', '/usr/local/kotlinc/bin/kotlinc-jvm')
KOTLIN_RUNTIME_PATH = env('KOTLIN_RUNTIME_PATH', 'java')
...
JAVA_COMPILE_COMMAND = env('JAVA_COMPILE_COMMAND', f'{JAVA_COMPILER_PATH} {{source}}')
JAVA_EXECUTE_COMMAND = env('JAVA_EXECUTE_COMMAND', f'{JAVA_RUNTIME_PATH} -cp {{workdir}} {{exe}}')
KOTLIN_COMPILE_COMMAND = env('KOTLIN_COMPILE_COMMAND', f'{KOTLIN_COMPILER_PATH} {{source}} -include-runtime -d {{workdir}}')
KOTLIN_EXECUTE_COMMAND = env('KOTLIN_EXECUTE_COMMAND', f'{KOTLIN_RUNTIME_PATH} -jar {{workdir}}/Main.jar')
